  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'font-mono focus:bg-accent focus:text-accent-foreground w-[48px] text-center text-base tabular-nums caret-transparent [&::-webkit-inner-spin-button]:appearance-none',
          className
        )}
