...
export const RadioControl = ({
  ...
  const radioClasses = cn(
    //Default style
    'border border-solid size-4.5 rounded-full appearance-none border-gray-600 relative flex items-center justify-center after:absolute after:size-3 after:rounded-full after:bg-blue-500 after:scale-0 after:transition-all after:duration-300 transition-all duration-300',
    //Hover style
    'hover:border-black',
    //Active style
