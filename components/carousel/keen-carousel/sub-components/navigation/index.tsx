...
export function CarouselNavigationButton({
  ...
  const wrapperClasses = cn(
    'absolute top-1/2 inline-flex h-9 w-9 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-white text-[1.25rem] text-black transition-opacity duration-300 opacity-100 aria-disabled:!opacity-0 border border-solid border-gray-light',
